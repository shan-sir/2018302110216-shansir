...
namespace winrt::WinUItest::implementation
{
    ...
    using INotifyDataErrorInfo = ::winrt::Microsoft::UI::Xaml::Data::INotifyDataErrorInfo;
    using DataErrorsChangedEventArgs = ::winrt::Microsoft::UI::Xaml::Data::DataErrorsChangedEventArgs;
    ...
    struct IXamlBindingTracking
    {
        ...
        virtual void ErrorsChanged(IInspectable const& sender, DataErrorsChangedEventArgs const& e) = 0;
    };
    ...
    struct XamlBindingTrackingBase
    {
        ...
        void ErrorsChanged(IInspectable const& sender, DataErrorsChangedEventArgs const& e);
        ...
        void UpdateErrorsChangedListener(INotifyDataErrorInfo const& obj, INotifyDataErrorInfo& cache, ::winrt::event_token& token);
        void UpdateErrorsChangedListener(INotifyDataErrorInfo const& obj, ::winrt::weak_ref<::winrt::Microsoft::UI::Xaml::Data::INotifyDataErrorInfo>& cache, ::winrt::event_token& token);
